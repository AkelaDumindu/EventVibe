...
if(isset($_GET['delete'])){
   ...
   header('location:planner_orders.php');
}
...
<section class="heading">
    <h3>placed orders</h3>
    <p> <a href="planner_page.php">home</a> / orders </p>
</section>
...
<section class="placed-orders">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <p> total events : <span><?php echo $fetch_orders['total_products']; ?></span> </p>
         ...
         <form action="" method="post">
            ...
            <a href="planner_orders.php?delete=<?php echo $fetch_orders['id']; ?>" class="delete-btn" onclick="return confirm('delete this order?');">delete</a>
         </form>
      </div>
      <?php
         }
